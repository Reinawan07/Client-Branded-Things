                        ...
                        <li>
                            ...
                            <ul id="dropdown-example" className="hidden py-2 space-y-2">
                                <div className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                                    <input
                                        type="radio"
                                        id="category-radio-chicken"
                                        name="category"
                                        value="1"
                                        className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                    />
                                    <label htmlFor="category-radio-chicken" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">All Category</label>
                                </div>
                                ...
                                <div className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                                    <input
                                        ...
                                        className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                    />
                                    <label htmlFor="category-radio-chicken" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Koleksi Atasan</label>
                                </div>

                                <div className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                                    <input
                                        type="radio"
                                        id="category-radio-drink"
                                        name="category"
                                        value="2"
                                        className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                    />
                                    <label htmlFor="category-radio-drink" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Koleksi Bawahan</label>
                                </div>
                            </ul>
                        </li>
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-4">
                        ...
                        <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <div style={{ height: "300px" }}>
                                <img className="object-cover w-full h-full rounded-t-lg" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRLF8Bwc6vlme8LCvoO2m0mjUL9dpJ2Gdjn6Q&usqp=CAU" alt="" />
                            </div>
